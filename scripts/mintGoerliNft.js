...
const { DEPLOYED_GOERLI_CONTRACT, WALLET_ADDRESS } = process.env;
...
module.exports = async function (callback) {
    ...
    const contract = new web3.eth.Contract(
        contractJson.abi,
        DEPLOYED_GOERLI_CONTRACT // this is the address generated when running migrate
    );

    // Generate a transaction to calls the `mint` method
